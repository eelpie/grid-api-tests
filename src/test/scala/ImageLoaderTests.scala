...
class ImageLoaderTests extends AnyFlatSpec with GridUnderTest {
  ...
  "Image loader sync end point" should "accept uploaded jpeg images and return upload status" in {
  ...
  "Image loader sync end point" should "accept uploaded TIFF images and return upload status" in {
  ...
  "Image loader sync end point" should "reject unsupported image types" in {
